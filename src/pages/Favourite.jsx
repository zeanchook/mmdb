...
export default function Favourite()
{
    ...
    return (<div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",backgroundColor:"pink"}}>
        <h1>Favourite</h1>
        <div style={{display:"flex",flexWrap:"wrap"}}></div >
        <div style={{display:"flex",flexWrap:"wrap",justifyContent:"center"}}>{topMMDBRatings}</div>
        </div>)
}
